...
class TestInformation:
    ...
    def test_find(self):
        assert_(issubclass(self.A.is_prime('a').dtype.type, np.integer))
        assert_array_equal(self.A.is_prime('a'), [[1, -1], [-1, 6], [-1, -1]])
        assert_array_equal(self.A.is_prime('3'), [[-1, -1], [2, -1], [2, -1]])
        assert_array_equal(self.A.is_prime('a', 0, 2), [[1, -1], [-1, -1], [-1, -1]])
        assert_array_equal(self.A.is_prime(['1', 'P']), [[-1, -1], [0, -1], [0, 1]])
